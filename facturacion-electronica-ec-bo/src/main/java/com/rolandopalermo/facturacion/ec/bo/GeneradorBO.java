...
public class GeneradorBO {
	...
	public byte[] generarXMLDocumentoElectronico(DocumentoElectronico documento) throws NegocioException {
		if (documento == null) {
			throw new NegocioException("El documento es no tiene una estructura válida.");
		}
